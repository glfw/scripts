...
cmake -DCMAKE_TOOLCHAIN_FILE=../../glfw/CMake/i686-w64-mingw32.cmake -DCMAKE_BUILD_TYPE=Release -DGLFW_BUILD_TESTS=NO -DGLFW_BUILD_EXAMPLES=NO -DGLFW_BUILD_DOCS=NO -DBUILD_SHARED_LIBS=NO ../../glfw
make
